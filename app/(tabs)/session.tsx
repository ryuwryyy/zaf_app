...
function createSessionStyles(
  ...
  return {
    ...
    wheelItem: { height: pickerItemHeight, justifyContent: 'center' as const, paddingLeft: spacing.md, paddingRight: spacing.sm },
    ...
    wheelUnitWrap: { height: pickerItemHeight * PICKER_VISIBLE_ROWS, justifyContent: 'center' as const, paddingLeft: 0, marginRight: scaleSize(12) },
